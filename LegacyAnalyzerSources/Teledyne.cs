...
{
    class Teledyne : deviceAnalyzer
    {
        public Teledyne(DeviceType dvType, string devID)
        {
        ...
        public Teledyne(DeviceType dvType, string devID, string devName, string ignorableErrors)
        {
