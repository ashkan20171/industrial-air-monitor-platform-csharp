...
namespace AshkanAQMS
{
 partial class MainDashboard
 {
  ...
  private void InitializeComponent()
  {
   ...
   var view=new ToolStripMenuItem("View"); view.DropDownItems.Add("Current Data",null,btnCurrentData_Click); view.DropDownItems.Add("Historical / Reports",null,btnReports_Click); view.DropDownItems.Add("Alarms & Audit",null,btnAlarms_Click); view.DropDownItems.Add("Data Explorer",null,btnExplorer_Click); view.DropDownItems.Add("Station Digital Twin",null,btnTwin_Click); view.DropDownItems.Add(new ToolStripSeparator()); view.DropDownItems.Add("Portfolio Showcase (Demo Data)",null,btnShowcase_Click);
   var tools=new ToolStripMenuItem("Tools"); tools.DropDownItems.Add("Remote",null,btnRemote_Click); tools.DropDownItems.Add("DAQ / Weather / UPS",null,btnIo_Click); tools.DropDownItems.Add("Communication Lab",null,btnCommLab_Click); tools.DropDownItems.Add("Diagnostics",null,btnDiagnostics_Click); tools.DropDownItems.Add("Integration Hub",null,btnIntegrations_Click); tools.DropDownItems.Add("Driver Test Bench",null,btnDriverBench_Click);
   var operations=new ToolStripMenuItem("Operations"); operations.DropDownItems.Add("Operations Planner",null,btnPlanner_Click); operations.DropDownItems.Add("Incident & Shift Handover",null,btnIncidents_Click); operations.DropDownItems.Add("Commissioning & Readiness",null,btnCommissioning_Click); operations.DropDownItems.Add("Data Quality & QA",null,btnQuality_Click); operations.DropDownItems.Add("Configuration Governance",null,btnGovernance_Click); operations.DropDownItems.Add("Feature Center",null,btnFeatures_Click); operations.DropDownItems.Add(new ToolStripSeparator()); operations.DropDownItems.Add("Operations Logbook",null,btnLogbook_Click); operations.DropDownItems.Add("Compliance & Data Governance",null,btnCompliance_Click); operations.DropDownItems.Add("Alarm Command Console",null,btnAlarmConsole_Click); operations.DropDownItems.Add("Access Governance / RBAC",null,btnAccess_Click); operations.DropDownItems.Add("Backup & Recovery",null,btnBackup_Click); operations.DropDownItems.Add(new ToolStripSeparator()); operations.DropDownItems.Add("Multi-Station Command Center",null,btnMultiStation_Click); operations.DropDownItems.Add("Notification & Escalation Center",null,btnNotifications_Click); operations.DropDownItems.Add("Configuration Versioning",null,btnConfigVersions_Click); operations.DropDownItems.Add("Calibration Evidence",null,btnCalibrationEvidence_Click);
   ...
   var spring=new ToolStripStatusLabel(){Spring=true}; var edition=new ToolStripStatusLabel("AshkanAQMS Enterprise • v15.0 Mission Control") { ForeColor=IndustrialTheme.Muted };
